...
<body>
	...
	<div class="container">
		<h2 class="text-center font-weight-bold">Análisis FODA</h2>
		<br>
			...
			<c:forEach var="departamentos" items="${departamentos}">
				...
				<div class="contenedor">
					<div class="view overlay">
					  <a href="${ urlRoot }analisis_foda/${departamentos.id_departamento}">
						...
						<div class="mask flex-center waves-effect waves-light rgba-white-strong">
							<form method="get" action="${ urlRoot }analisis_foda/${ departamentos.ruta}/${departamentos.id_departamento}">
