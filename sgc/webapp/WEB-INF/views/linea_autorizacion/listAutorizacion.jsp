...
<body>
	...
	<div class="container">
		<h3 class="text-center font-weight-bold">Línea de Autorización</h3>
		<br>
		...
		<div class="table-responsive">
    	    <table class="table table-hover table-striped table-bordered">
            	...
            	<tr>
    	        	...
    	        	<td><a class="text-dark" href="${ urlRoot }linea-autorizacion/${departamentos.id_departamento}">Linea de autorización del Departamento de ${ departamentos.nombre }</a></td>
	            </tr>
            	</c:forEach>
        	</table>
      	</div>
