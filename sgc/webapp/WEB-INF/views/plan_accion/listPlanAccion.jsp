...
<body>
	...
	<div class="container">
		<h2 class="text-center font-weight-bold">Plan de Acción</h2>
		<br>
			...
			<c:forEach var="departamentos" items="${departamentos}">
				...
				<div class="contenedor">
					<div class="view overlay">
					  <a href="${ urlRoot }plan_accion/${departamentos.id_departamento}">
						...
						<div class="mask flex-center waves-effect waves-light rgba-white-strong">
							<form method="get" action="${ urlRoot }plan_accion/${ departamentos.ruta}/${departamentos.id_departamento}">
