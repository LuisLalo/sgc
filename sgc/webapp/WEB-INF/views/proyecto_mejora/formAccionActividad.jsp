...
<spring:url value="/proyecto_mejora/guardarActividad" var="urlForm"></spring:url>
...
<body>
	...
	<div class="container">
		...
		<br>
		<h3 class="text-center font-weight-bold">Agregar Nueva Actividad del Proyecto de Mejora</h3>
		<br>
	...
	<a href="${ urlRoot }proyecto_mejora/index" class="btn btn-success" role="button" title="Terminar" >Terminar</a><br><br>
	</div>
