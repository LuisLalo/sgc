...
<body>
	...
	<div class="container">
		<h2 class="text-center font-weight-bold">Proyectos de Mejora</h2>
		<br>
			...
			<c:forEach var="departamentos" items="${departamentos}">
				...
				<div class="contenedor">
					<div class="view overlay">
					  <a href="${ urlRoot }proyecto_mejora/${departamentos.id_departamento}">
						...
						<div class="mask flex-center waves-effect waves-light rgba-white-strong">
							<form method="get" action="${ urlRoot }proyecto_mejora/${ departamentos.ruta}/${departamentos.id_departamento}">
