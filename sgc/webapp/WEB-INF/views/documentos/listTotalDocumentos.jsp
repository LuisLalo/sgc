      ...
      <div class="table-responsive">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tr>
                ...
                <td>${ documentos.id_clasificador_documento }</td>
                <td>${ documentos.id_departamento }</td>
                <c:choose>
                	<c:when test="${ documentos.estatus eq 'Activo'}">
                		<td><span class="label label-success">${ documentos.estatus }</span></td><td>
                	</c:when>
                	<c:otherwise>
                		<td><span class="label label-danger">${ documentos.estatus }</span></td><td>
                	</c:otherwise>
                </c:choose>
                    <a href="${ urlEditar }/${documentos.id_documento}" class="btn btn-success btn-sm" role="button" title="Editar" ><span class="glyphicon glyphicon-pencil"></span></a>
                    <a href="${ urlEliminar }/${documentos.id_documento}" onclick='return confirm("¿Estás seguro que deseas eliminar este documento?")' class="btn btn-danger btn-sm" role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
            </tr>
            </c:forEach>
