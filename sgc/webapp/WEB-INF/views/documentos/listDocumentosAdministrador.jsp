...
<body>
	...
	<div class="container">
		<c var="tipoDocumento" items="${ tipoDocumento }">
		<h3 class="text-center font-weight-bold">Lista de ${ tipoDocumento.nombre }</h3>
		</c>
      ...
      <div class="table-responsive">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tr>
                ...
                <c:choose>
                	<c:when test="${ documentos.estatus eq '0'}">
                    ...
                    <a href="${ urlEditar }/${documentos.idDocumento}" class="btn btn-success btn-sm" role="button" title="Editar" ><span class="glyphicon glyphicon-pencil"></span></a>
