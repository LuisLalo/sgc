			...
			<c:forEach var="tipoDocumento" items="${tipoDocumento}">
				...
				<div class="contenedor">
					<div class="view overlay">
					  <a href="${ urlRoot }documentos/${tipoDocumento.idTipoDocumento}">
						<img src="${ urlResources }/images/${tipoDocumento.imagen}" alt="..."  class="img-fluid img-rounded" onmouseover="enfoque(this)"onmouseout="noenfoque(this)">
						<div class="mask flex-center waves-effect waves-light rgba-white-strong">
							<form method="get" action="${ urlRoot }documentos/${ tipoDocumento.imagen}/${tipoDocumento.imagen}">
