...
<body>
	...
	<div class="container">
		<h3 class="text-center font-weight-bold">Documentos por Autorizar</h3>
		<br>
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tr>
            	...
            	<td><a class="text-dark" href="${ urlRoot }documentos/autorizar/${ departamentos.ruta}/${departamentos.id_departamento}">Formatos de ${ departamentos.nombre }</a></td>
            </tr>
            </c:forEach>
        </table>
      </div>
