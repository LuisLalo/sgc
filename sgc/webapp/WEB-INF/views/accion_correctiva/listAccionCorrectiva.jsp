...
<body>
	...
	<div class="container">
		<h2 class="text-center font-weight-bold">Acciones Correctivas</h2>
		<br>
			...
			<c:forEach var="departamentos" items="${departamentos}">
				...
				<div class="contenedor">
					<div class="view overlay">
					  <a href="${ urlRoot }accion_correctiva/${departamentos.id_departamento}">
						...
						<div class="mask flex-center waves-effect waves-light rgba-white-strong">
							<form method="get" action="${ urlRoot }accion_correctiva/${ departamentos.ruta}/${departamentos.id_departamento}">
