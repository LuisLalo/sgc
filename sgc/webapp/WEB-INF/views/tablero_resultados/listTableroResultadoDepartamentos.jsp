...
<body>
	...
	<div class="container">
		<h3 class="text-center font-weight-bold">Tablero de Resultados de ${ departamentos.nombre }</h3>
		<br>
	<div class="table-responsive">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    <a href="${ urlResources }/docs/tablero_resultados/${ departamentos.ruta }/${documentos.ruta}" class="btn btn-success btn-sm" role="button" title="Descargar" ><span class="glyphicon glyphicon-download-alt"></span></a>
				</td>
			</tr>                  
            </c:forEach>
        </table>
