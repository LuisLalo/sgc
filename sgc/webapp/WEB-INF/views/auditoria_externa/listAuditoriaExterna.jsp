	...
	<div class="container">
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    <a href="${ urlResources }/docs/auditoria_externa/${documentos.ruta}" class="btn btn-success btn-sm" role="button" title="Editar" ><span class="glyphicon glyphicon-download-alt"></span></a>
            	</td>
            </tr>
            </c:forEach>
        </table>
