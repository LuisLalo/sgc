...
public class AnalisisRiesgoController {
	...
	@GetMapping("/crear")
	public String crearAnalisisRiesgo(@ModelAttribute DocumentoActualizar documentoActualizar, Model model, Authentication authentication) {
		// Se agrega el nombre del usuario
		UsuarioConsulta usuarioAuth = serviceUsuariosConsulta.buscarPorCorreo(authentication.getName());
		model.addAttribute("usuarioAuth", usuarioAuth);
		
		TipoDocumento tipoDocumento = serviceTiposDocumentos.buscarPorNombre("Análisis de Riesgo");
		model.addAttribute("tipoDocumento", tipoDocumento);
		
		return "analisis_riesgo/formAnalisisRiesgo";
	}
	...
	public String guardar(@ModelAttribute DocumentoActualizar documento, Authentication authentication, BindingResult result, RedirectAttributes attribute, @RequestParam("ruta") MultipartFile multiPart, HttpServletRequest request) {
		...
		return "redirect:/analisis_riesgo/index";
	}
