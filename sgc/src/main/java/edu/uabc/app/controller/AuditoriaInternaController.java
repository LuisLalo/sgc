...
@Controller
@RequestMapping("/auditoria_interna")
public class AuditoriaInternaController {
	...
	public String mostrarIndex(Model model, Authentication authentication) {
		...
		//List<DocumentoActualizar> lista = Utileria.identificarAuditoriaInterna(listaDocumento, lineaAutorizacion.size());
		...
		*/
		...
		return "auditoria_interna/listAuditoriaInterna";
	}
}
